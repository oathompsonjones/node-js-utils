...
describe("parseTime", () => {
    ...
    it("should be able to parse each way of writing hours", () => {
    ...
    it("should return the total number of milliseconds", () => {
