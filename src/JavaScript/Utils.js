...
function parseTime(str) {
    ...
    times.forEach((time) => {
        ...
        if (time.match(regExp.millisecond) !== null)
            ...
            ms += values.second * parseInt((_d = (_c = time.match(regExp.second)) === null || _c === void 0 ? void 0 : _c[0]) !== null && _d !== void 0 ? _d : "0");
            ...
            ms += values.hour * parseInt((_h = (_g = time.match(regExp.hour)) === null || _g === void 0 ? void 0 : _g[0]) !== null && _h !== void 0 ? _h : "0");
        else if (time.match(regExp.day) !== null)
            ms += values.day * parseInt((_k = (_j = time.match(regExp.day)) === null || _j === void 0 ? void 0 : _j[0]) !== null && _k !== void 0 ? _k : "0");
        else if (time.match(regExp.week) !== null)
            ms += values.week * parseInt((_m = (_l = time.match(regExp.week)) === null || _l === void 0 ? void 0 : _l[0]) !== null && _m !== void 0 ? _m : "0");
        else if (time.match(regExp.month) !== null)
            ms += values.month * parseInt((_p = (_o = time.match(regExp.month)) === null || _o === void 0 ? void 0 : _o[0]) !== null && _p !== void 0 ? _p : "0");
